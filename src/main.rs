...
enum Command {
    ...
    author = "Ming Chang (mail@mingchang.tw)",
    long_about = "\nA CLI helper for Spring Web projects.\n\n'quick-start' subcommand will create basic project structure (Controllers, Services, Service Implements, Models and Spring Data R2DBC Repositories) with PostgreSQL tables."
    )]
    QuickStart {
